...
# ----------------------------------------------------------------------------
def c2rt_channel_number(chirp_location):
    return f"{int(chirp_location)}"

# ----------------------------------------------------------------------------
def c2rt_rx_frequency(chirp_frequency):
    return f"{float(chirp_frequency):.5f}"

# ----------------------------------------------------------------------------
def c2rt_tx_frequency(rx_frequency, chirp_duplex, chirp_offset):
...
# ----------------------------------------------------------------------------
def c2rt_CTCSS_tone(chirp_tone_mode, chirp_rx_tone_freq):
    rt_tone_mode = c2rt_tone(chirp_tone_mode)
    tone_freq = float(chirp_rx_tone_freq)
    rt_CTCSS_tone = ''
...
# ----------------------------------------------------------------------------
def c2rt_step(chirp_step):
    return f"{chirp_step} kHz"

# ----------------------------------------------------------------------------
def truncate_comments(chirp_comment, max_size):
...
def chirp2rt(raw_chirp_data):
    ...
    for chirp_row in raw_chirp_data:
        ...
        receive_frequency = c2rt_rx_frequency(chirp_row['Frequency'])
...
# ----------------------------------------------------------------------------
def export_RT(output_file, RT_rows):
...
def convert(input_file, output_file):
    ...
    export_RT(output_file, RT_content)
